...
public class RelationTest {
	...
	public void create_relation_with_lexicographical_order_of_type_names() {
		Relation r1 = Relation.create(new Type("A_should_be_1st"), new Type("B_should_be_2nd"));
		Relation r2 = Relation.create(new Type("B_should_be_2nd"), new Type("A_should_be_1st"));
	...
	public void create_Key_fns_make_Keys_based_on_alphabetical_order_of_names() {
		Relation.Key k1 = Relation.createKey(new Type("BType"), new Type("AType"));
	...
	public void create_and_createKey_make_same_Keys() {
		Relation r = Relation.create(new Type("BType"), new Type("AType"));
